...
onMounted(() => {
  ...
  const res = store.getters?.["dict/filterDicts"](['JQ_TYPE', 'HZ_INFO_QY', 'HZ_QHCS', 'HZ_QHYY', 'HZ_INFO_HZDJ', 'HZ_QHWZ_CS', 'HZ_QHXT_SGXT', 'HZ_INFO_BGSY',
    ...
    'CAR_TYPE', 'JQ_STATUS', 'CD_LOOK', 'HZ_QHW_TYPE', 'HZ_YHY', 'HZ_INFO_RWYS', 'HZ_INFO_SSBW', 'HZ_INFO_YY', 'DEPT_NATURE', 'HZ_QHWZ_JTGJ', 'USER_JOB', 'CD_CZRY_ZMBW', 'CD_CZRY_SWYY'], null, false)
